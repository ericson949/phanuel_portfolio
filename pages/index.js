  ...
  return (
    <Layout>
      <PageSection color={color}>
        <PageWrapper>
          <article>
            <h1 data-text="I'm A. Phanuel Wayne" className="intro__text">
              <mark className="mark">I&apos;m A. Phanuel Wayne</mark>
            </h1>
            <p>
              Full Stack developer,
              <br />
              UX architect and Javascript engineer
            </p>
            <p>
